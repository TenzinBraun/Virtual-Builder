...
public class TriggerControllerProtocol3 : MonoBehaviour {
    ...
    private void Initialize()
    {
        ...
        fullResolutionGameObject.transform.position = MODEL_POSITION_IN_BOX;
    ...
    private void SwitchBeetwenModels(int indicatorDegradedModel, int indicatorFullResolution)
    {
        ...
        {
            ChangeDegradedModel(indicatorDegradedModel);

            if (this.indicatorDegradedModel == 3)
    ...
    /// </summary>
    /// <param name="indicatorDegradedModel"></param>
    private void ChangeDegradedModel(int indicatorDegradedModel)
    {
    ...
    private void ChangeTypeOfModel(int indicatorFullResolution)
    {
        ...
        ChangeDegradedModel(resetDegradedModelIndicator);
    }
